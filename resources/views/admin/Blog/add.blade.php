...
@section('container')
    ...
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">افزودن بلاگ</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form enctype="multipart/form-data" method="post" action="{{route('panel.store_blog')}}" role="form">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input name="image_alt" type="text" class="form-control" id="exampleInputEmail1"
                           placeholder="مثال : سورین آز ,کلمه کلیدی">
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <textarea id="open-source-plugins2" name="fulltext" style="width: 100%"
                                 ></textarea>
                    </div>
                </div>
            </div>
