...
@section('container')
    ...
    <div class="card card-success">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form enctype="multipart/form-data" method="post" action="{{route('panel.update_product', $products->id)}}" role="form">
            @csrf
            @method('PATCH')
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <img src="{{asset($products->image)}}" alt="" class="w-25">
                ...
                <div class="form-group">
                    ...
                    <input name="image_alt" type="text" class="form-control" id="exampleInputEmail1"
                           placeholder="مثال :  شینیون در بیونا" value="{{$products->image_alt}}">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">(کلمات کلیدی)</label>
                    <input name="keywords" type="text" class="form-control" id="exampleInputEmail1"
                           placeholder="مثال : بیونا ,  شینیون در بیونا" value="{{$products->keywords}}">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">عنوان</label>
                    <input name="title" type="text" class="form-control" id="exampleInputEmail1"
                           placeholder="6 کلمه" value="{{$products->title}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" id="" cols="30" rows="10"
                              placeholder="توضیح مختصر...(حداکثر  3.5سطر)">{{$products->description}}</textarea>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <textarea id="open-source-plugins" name="fulltext" >{{$products->fulltext}}</textarea>
                    </div>
                </div>
            </div>
            <div class="form-group d-none">
                <label for="">متن بعد گالری</label>
                <div class="card-body">
                    <div class="mb-3">
