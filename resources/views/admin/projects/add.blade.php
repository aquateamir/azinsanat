...
@section('container')
    ...
    <div class="card card-success">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form enctype="multipart/form-data" method="post" action="{{route('panel.store_project')}}" role="form">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="category[]" class="form-control w-100" multiple=""
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" id="" cols="30" rows="10"
                              placeholder="توضیح مختصر...(حداکثر  3.5سطر)"></textarea>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <textarea id="open-source-plugins" name="fulltext"></textarea>
                    </div>
                </div>
            </div>
            <div class="form-group d-none">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <textarea id="open-source-plugins2" name="afterImgText" style="width: 100%"
