...
@section('container')
    ...
    <div class="card card-success">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form enctype="multipart/form-data" method="post" action="{{route('panel.update_project', $blog->id)}}" role="form">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <textarea id="open-source-plugins" name="fulltext">{{html_entity_decode($blog->fulltext)}}</textarea>
                    </div>
                </div>
            </div>
